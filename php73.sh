...
packages='php73 php73-php-fpm php73-php-devel php73-php-embedded php73-php-mysqlnd php73-php-bcmath php73-php-enchant php73-php-gd php73-php-pecl-geoip php73-php-gmp php73-php-pecl-igbinary php73-php-pecl-igbinary-devel php73-php-pecl-imagick php73-php-pecl-imagick-devel php73-php-imap php73-php-intl php73-php-pecl-json-post php73-php-ldap php73-php-pecl-mailparse php73-php-mbstring php73-php-mcrypt php73-php-pecl-memcache php73-php-pecl-memcached php73-php-pecl-mysql php73-php-pdo-dblib php73-php-pspell php73-php-pecl-redis php73-php-snmp php73-php-soap php73-php-tidy php73-php-xml php73-php-xmlrpc php73-php-pecl-zip php73-php-opcache'
...
phpinstall() {
  ...
  sed -i 's|9000|10000|' /etc/opt/remi/php73/php-fpm.d/www.conf
  sed -i 's|9000|10000|' /usr/local/nginx/conf/php73-remi.conf
